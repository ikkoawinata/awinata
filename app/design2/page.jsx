...
const Candidates = () => {
  ...
  return (
    <>
      <section className="py-2 md:py-4 xl:py-6 h-[140vh] md:h-[120vh] xl:h-[130vh] xl:pt-8 bg-no-repeat bg-bottom dark:bg-none relative flex items-center justify-center">
        <div className="flex flex-col items-center text-center">
          {/* Image with Description */}
          <div className="w-full max-w-md mx-auto p-3 md:p-4 xl:p-6">
            <img
              src="./hero/port3.png"
              alt="Descriptive Alt Text"
              className="w-full h-auto object-cover"
            />
            <p className="mt-4 md:mt-5 xl:mt-6 text-md font-light text-gray-700 dark:text-gray-300 text-justify">
              Organized by the GEMA UNESA Campus Press Institute with the theme
              "Take Your Infographic to the Next Level with Illustrations"
            </p>
            <img
            ...
            className="w-full h-auto object-cover"
          />
            <p className="mt-6 md:mt-8 xl:mt-10 text-sm font-bold text-gray-700 dark:text-gray-300 text-justify">
              • 25 June 2022
            </p>
      ...
      {/* Additional Section */}
      <section className="py-2 md:py-4 xl:py-6 h-auto md:h-auto xl:h-auto xl:pt-0 bg-no-repeat bg-bottom dark:bg-none relative flex items-center justify-center">
        <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto p-2 md:p-3 xl:p-4">
          {/* <img
            src="./hero/sertif1.png"
            alt="Another Descriptive Alt Text"
            className="w-full h-auto object-cover"
